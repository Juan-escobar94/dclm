...
# 
python3 ray_processing/process.py --source_ref_paths exp_data/datasets/raw_sources/dclm-pool-400m-1x_local.json --readable_name dclm_wiki_combined_second_try --output_dir /data/horse/ws/jori152b-datacomp_data/dclmAndWikiSecondTry/ --config_path baselines/baselines_configs/dclmAndWiki.yaml --source_name cc 
